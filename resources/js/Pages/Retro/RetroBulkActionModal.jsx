// Save this as: resources/js/Pages/Retro/RetroBulkActionModal.jsx
import React, { useState } from 'react';

const RetroBulkActionModal = ({ selectedCount, onClose, onSubmit, userRoles = {} }) => {
                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 className="text-lg leading-6 font-medium text-gray-900">
                                    Bulk Update {selectedCount} Retro Request{selectedCount !== 1 ? 's' : ''}
                                </h3>
                                <div className="mt-4">
                                    <div className="mb-4">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Enter remarks for retro requests"
                                        ></textarea>
                                    </div>
                                </div>
                            </div>
...
export default RetroBulkActionModal;