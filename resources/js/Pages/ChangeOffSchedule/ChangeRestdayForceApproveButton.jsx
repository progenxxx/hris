...
const ChangeRestdayForceApproveButton = ({ selectedIds, disabled }) => {
    ...
    const openModal = () => {
        if (selectedIds.length === 0) {
            alert('Please select at least one change rest day request to force approve');
            return;
        }
        setIsOpen(true);
    };
    ...
    const handleForceApprove = () => {
        ...
        router.post(route('change-off-schedules.force-approve'), {
            ...
            onSuccess: () => {
                ...
                setTimeout(() => {
                    closeModal();
                    window.location.href = route('change-off-schedules.index');
    ...
    return (
        <>
            <button
                ...
                title="Force Approve Selected Change Rest Days"
            >
                            ...
                            {showSuccessImage ? (
                                ...
                                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 text-center">
                                    ...
                                    <p className="mt-2 text-sm text-gray-500">
                                        The selected change rest day requests have been approved.
                                    </p>
                                </div>
                            ) : (
                                <>
                                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <div className="sm:flex sm:items-start">
                                            ...
                                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                                <h3 className="text-lg leading-6 font-medium text-gray-900">
                                                    Force Approve {selectedIds.length} Change Rest Day Request{selectedIds.length !== 1 ? 's' : ''}
                                                </h3>
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">
                                                        This will bypass the normal approval workflow and immediately approve the selected change rest day request(s). This action cannot be undone.
                                                    </p>
                                                </div>
                                                <div className="mt-4">
...
export default ChangeRestdayForceApproveButton;