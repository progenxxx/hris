...
const ChangeRestdayBulkActionModal = ({ selectedCount, onClose, onSubmit, userRoles = {} }) => {
                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 className="text-lg leading-6 font-medium text-gray-900">
                                    Bulk Update {selectedCount} Change Rest Day Request{selectedCount !== 1 ? 's' : ''}
                                </h3>
                                <div className="mt-4">
                                    <div className="mb-4">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            placeholder={`Enter remarks for change rest day requests`}
                                        ></textarea>
                                        {status === 'rejected' && (
                                            <p className="mt-1 text-sm text-gray-500">
                                                Remarks are required when rejecting change rest day requests
                                            </p>
                                        )}
                                        {status === 'force_approved' && (
                                            <p className="mt-1 text-sm text-gray-500">
...
export default ChangeRestdayBulkActionModal;