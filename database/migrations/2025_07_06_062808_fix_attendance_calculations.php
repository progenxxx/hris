    ...
    public function up(): void
    {
        ...
        foreach ($attendances as $attendance) {
            try {
                ...
                // Calculate late minutes (NO grace period - 8:00 AM sharp)
                $lateMinutes = 0;
                ...
                \Log::error("Error fixing attendance ID {$attendance->id}: " . $e->getMessage());
            }
        }
        
        \Log::info('Attendance calculations migration completed', [
