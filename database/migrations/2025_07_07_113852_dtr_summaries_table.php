...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payroll_summaries', function (Blueprint $table) {
            ...
            // Summary fields
            $table->decimal('days_worked', 5, 2)->default(0)->comment('Total number of days worked');
            $table->decimal('ot_hours', 8, 2)->default(0)->comment('Total OT hours');
            $table->decimal('off_days', 5, 2)->default(0)->comment('Total rest days');
            $table->decimal('late_under_minutes', 8, 2)->default(0)->comment('Total late and undertime minutes');
            $table->decimal('nsd_hours', 8, 2)->default(0)->comment('Total night shift differential hours');
            $table->decimal('slvl_days', 5, 2)->default(0)->comment('Total SLVL days');
            $table->decimal('retro', 10, 2)->default(0)->comment('Total retroactive pay');
